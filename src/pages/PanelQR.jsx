...
export default function PanelQR() {
    ...
    const [tables, setTables] = useState(Array.from({ length: 10 }, (_, i) => i + 1));
    ...
    return (
        <>
            <div className="flex justify-between items-center mb-6 print:hidden">
                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        <label className="text-sm font-medium text-gray-700">Cantidad de Mesas:</label>
                        <input
                            type="number"
                            min="1"
                            max="100"
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 print:grid-cols-3 print:gap-8">
                {tables.map(num => (
                    <div key={num} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex flex-col items-center text-center print:border-2 print:border-gray-900 print:shadow-none">
                        <h3 className="text-xl font-bold mb-4 text-gray-900">Mesa {num}</h3>
                        ...
                        <p className="mt-4 text-sm text-gray-500 font-medium">Escanea para pedir</p>
                    </div>
                ))}
            </div>
